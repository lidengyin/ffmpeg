...
import com.example.ffmpg.demo.config.FFmpegConfig;
...
import com.example.ffmpg.demo.util.PropertiesUtil;
...
public interface FFmpegManager {
	public static FFmpegConfig config=(FFmpegConfig) PropertiesUtil.load("loadFFmpeg.properties",  FFmpegConfig.class);
	/**
	 * 注入自己实现的持久层
	 * 
	 * @param taskDao
