...
import com.example.ffmpg.demo.dao.TaskDao;
import com.example.ffmpg.demo.dao.TaskDaoImpl;
import com.example.ffmpg.demo.entity.TaskEntity;
import com.example.ffmpg.demo.service.CommandAssembly;
import com.example.ffmpg.demo.service.CommandAssemblyImpl;
import com.example.ffmpg.demo.service.TaskHandler;
import com.example.ffmpg.demo.service.TaskHandlerImpl;
...
public class FFmpegManagerImpl implements FFmpegManager {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Map map = new HashMap();
		map.put("appName", "mylive");
		map.put("input", "/home/lidengyin/Videos/2-1linux软件源配置与学习建议.mp4");
		map.put("output", "rtmp://121.36.145.230/mylive/4");
		map.put("codec", "h264");
		map.put("fmt", "flv");
		map.put("fps", "25");
		map.put("rs", "640x360");
